...
export default function OrderCheck() {
  ...
  const [orderCheck, newOrder, sumDiv, AllPrice, trueOrder] = useHome((state: homeState) => [state.orderCheck, state.newOrder, state.sumDiv, state.AllPrice, state.trueOrder], shallow);
